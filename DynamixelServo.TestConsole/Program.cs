    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (DynamixelDriver driver = new DynamixelDriver("COM4"))
            {
                ...
                driver.SetComplianceSlope(1, ComplianceSlope.S128);
                // 600 - 450
                // 600 - 700
                driver.MoveToBlocking(3, 600);
                driver.MoveToBlocking(1, 450);
                driver.MoveToBlocking(3, 700);
                driver.MoveToBlocking(3, 600);

                driver.MoveToBlocking(1, 500);
                driver.MoveToBlocking(3, 700);
                driver.MoveToBlocking(3, 600);

                driver.MoveToBlocking(1, 550);
                driver.MoveToBlocking(3, 700);
                driver.MoveToBlocking(3, 600);

                driver.MoveToBlocking(1, 600);
                driver.MoveToBlocking(3, 700);
                driver.MoveToBlocking(3, 600);
            }
